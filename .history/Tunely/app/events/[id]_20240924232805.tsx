...
export default function EventDetails() {
  ...
  const openMaps = async () => {
    ...
    let googleMapsURL = '';
    let browserURL = `https://www.google.com/maps/search/?api=1&query=${latitude},${longitude}`;

    if (Platform.OS === 'ios') {
      googleMapsURL = `comgooglemaps://?q=${latitude},${longitude}`;
    } else {
      googleMapsURL = `geo:${latitude},${longitude}?q=${latitude},${longitude}(${label})`;
    }
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.detailsContainer}>
          ...
          <View style={styles.locationHeader}>
            ...
            <TouchableOpacity onPress={openMaps} accessibilityLabel="Open location in Google Maps">
